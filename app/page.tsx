  ...
  const features = [
    {
      ...
      description: "Log, categorize, and track coding errors with detailed descriptions and priority levels.",
      icon: <Bug className="size-5" />,
    },
    {
      title: "Collaborative Solutions",
      description: "Work together to solve coding issues with comments, upvotes, and shared solutions.",
      icon: <Users className="size-5" />,
    },
    {
      title: "Comprehensive Search",
      description: "Find solutions quickly with advanced search filters and AI-powered recommendations.",
      icon: <Search className="size-5" />,
    },
    {
      title: "Team Management",
      description: "Assign errors to team members and track progress from start to resolution.",
      icon: <MessageSquare className="size-5" />,
    },
    {
      title: "Analytics Dashboard",
      description: "Gain insights with detailed reports on error patterns, resolution times, and team performance.",
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6 relative">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                The collaborative platform for developers to log, share, and solve coding errors. Track issues, find
                solutions, and learn from the community.
              </p>
        ...
        <section className="w-full py-12 border-y bg-muted/30">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <p className="text-sm font-medium text-muted-foreground">Trusted by developers and teams worldwide</p>
        ...
        <section id="features" className="w-full py-20 md:py-32">
          <div className="container px-4 md:px-6">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Track, Solve, and Learn</h2>
              <p className="max-w-[800px] text-muted-foreground md:text-lg">
                Our comprehensive platform provides all the tools you need to manage coding errors, collaborate with
                teammates, and improve code quality.
              </p>
            </motion.div>
        ...
        <section id="howitworks" className="w-full py-20 md:py-32 bg-muted/30 relative overflow-hidden">
          ...
          <div className="container px-4 md:px-6 relative">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight">From Error to Resolution</h2>
              <p className="max-w-[800px] text-muted-foreground md:text-lg">
                Our streamlined workflow makes solving code errors fast and efficient.
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-12 relative">
              ...
              {[
                ...
                },
                {
                  ...
                  description: "Access verified solutions, track progress, and mark errors as resolved once fixed.",
                },
              ].map((step, i) => (
                <motion.div
                  key={i}
        ...
        <section className="w-full py-20 md:py-32">
          <div className="container px-4 md:px-6">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Access Levels for Every Need</h2>
              <p className="max-w-[800px] text-muted-foreground md:text-lg">
                FixIt provides different levels of access based on your requirements, from browsing solutions to
                managing teams.
              </p>
            </motion.div>

            <Tabs defaultValue="registered" className="w-full max-w-4xl mx-auto">
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">Browse the knowledge base</p>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <h4 className="font-medium">Search for errors using keywords</h4>
                          <p className="text-sm text-muted-foreground">Find solutions to common coding problems</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        <Check className="size-5 text-primary mt-0.5" />
                        <div>
                          <h4 className="font-medium">View public error logs and solutions</h4>
                          <p className="text-sm text-muted-foreground">Access a vast library of community solutions</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-2 opacity-50">
                        <X className="size-5 text-muted-foreground mt-0.5" />
                        <div>
                          <h4 className="font-medium">Cannot comment, vote, or log new errors</h4>
                          <p className="text-sm text-muted-foreground">Limited to viewing existing content</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-2 opacity-50">
                        <X className="size-5 text-muted-foreground mt-0.5" />
                        <div>
                          <h4 className="font-medium">Cannot assign or track errors</h4>
                          <p className="text-sm text-muted-foreground">No team management features</p>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">Contribute to the community</p>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <div className="flex items-start gap-2">
                        <Check className="size-5 text-primary mt-0.5" />
                        <div>
                          <h4 className="font-medium">Log new errors with details</h4>
                          <p className="text-sm text-muted-foreground">Title, description, category, and tags</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        <Check className="size-5 text-primary mt-0.5" />
                        <div>
                          <h4 className="font-medium">Comment on errors and solutions</h4>
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Upvote and downvote community solutions</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        <Check className="size-5 text-primary mt-0.5" />
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">View upvoted solutions, discussions, and more</p>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-2">
                        <Check className="size-5 text-primary mt-0.5" />
                        <div>
                          <h4 className="font-medium">Create and join organizations/teams</h4>
                      ...
                      <div className="flex items-start gap-2">
                        <Check className="size-5 text-primary mt-0.5" />
                        <div>
                          <h4 className="font-medium">Assign errors to team members</h4>
                          <p className="text-sm text-muted-foreground">Delegate tasks to the right people</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        <Check className="size-5 text-primary mt-0.5" />
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Monitor progress from open to resolved</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        <Check className="size-5 text-primary mt-0.5" />
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Team-level analytics and insights</p>
                        </div>
                      </div>
                    </div>
                  </CardContent>
        ...
        <section className="w-full py-20 md:py-32 bg-gradient-to-br from-primary to-primary/80 text-primary-foreground relative overflow-hidden">
          ...
          <div className="container px-4 md:px-6 relative">
            ...
            >
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight">Ready to Fix Errors Faster?</h2>
              <p className="mx-auto max-w-[700px] text-primary-foreground/80 md:text-xl">
                Join thousands of developers who have streamlined their debugging process and improved their code
                quality with FixIt.
              </p>
          ...
          <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                The collaborative platform for developers to log, share, and solve coding errors efficiently.
              </p>
