...
export default function MyErrorsPage() {
  ...
  useEffect(() => {
    const fetchErrors = async () => {
      ...
      try {
        const response = await fetch("http://127.0.0.1:8000/bugtracker/all-errors/", {
          method: "GET",
          credentials: "include",
          headers: {
        ...
        const response2 = await fetch("http://127.0.0.1:8000/bugtracker/public-errors/", {
          method: "GET",
          credentials: "include",
          headers: {
            "Content-Type": "application/json",
          ...
          >
            {authenticated && accountType === "Premium" && (
              <TabsList className="grid w-full grid-cols-2 sm:w-[400px]">
                <TabsTrigger value="created">ALL</TabsTrigger>
                <TabsTrigger value="assigned">Public</TabsTrigger>
              </TabsList>
            )}
          </Tabs>
              ...
              <div className="py-12 text-center">
                ...
                <p className="text-sm text-muted-foreground max-w-md mx-auto mb-6">
                  {activeTab === "created"
                    ...
                    : "You don't have any errors Public to you that match the current filters."}
                </p>
                <Button asChild>
                  <Link href="/dashboard/new-error">
                    <PlusCircle className="mr-2 h-4 w-4" />
